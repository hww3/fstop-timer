...
FstopComms::FstopComms(LiquidCrystalFast &l, OpenExecutor &oe)
    : disp(l), exec(oe)
{
...
FstopTimer::FstopTimer(LiquidCrystalFast &l, SMSKeypad &k, RotaryEncoder &r,
                       ButtonDebounce &b,
...
void Program::Exposure::display(LiquidCrystalFast &disp, bool lin)
{
    // print text
    disp.clear();
    disp.setCursor(0,0);
...
void Program::Exposure::displayTime(LiquidCrystalFast &disp, bool lin)
{
    disp.setCursor(0,1);
...
Executor::Executor(LiquidCrystalFast &l, Keypad &k, ButtonDebounce &b, char p_e, int &w)
...
OpenExecutor::OpenExecutor(LiquidCrystalFast &l, char p_e, int &w)
