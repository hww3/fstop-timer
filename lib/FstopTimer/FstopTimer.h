...
public:
    ...
    public:
        ...
        void display(LiquidCrystalFast &disp, bool lin);
        /// render only the time line (bottom row);
        void displayTime(LiquidCrystalFast &disp, bool lin);
...
public:
    ...
    OpenExecutor(LiquidCrystalFast &l, char p_e, int &w);
...
public:
    ...
    Executor(LiquidCrystalFast &d, Keypad &k, ButtonDebounce &b, char p_e, int &w);
...
public:
    ...
    FstopComms(LiquidCrystalFast &l, OpenExecutor &oe);
...
public:
    ...
    FstopTimer(LiquidCrystalFast &l, SMSKeypad &k, RotaryEncoder &r,
               ButtonDebounce &b,
