...
public:
    ...
    Keypad(char c0, char c1, char c2, char c3, char r0, char r1, char r2, char r3, bool rev=false);
 ...
 * entry.  Needs a pointer to a LiquidCrystalFast so that it can manage
...
public:
    ...
    public:
        ...
        Context(char *b, unsigned ml, LiquidCrystalFast *l, unsigned char c, unsigned char r);
        ...
        LiquidCrystalFast * const lcd;  ///< where to render entered chars
        const unsigned lcdc, lcdr; ///< cursor position on LCD to render at
        char exitcode;       ///< KP_B, KP_C or KP_D that terminated the read
    };

    SMSKeypad(char c0, char c1, char c2, char c3, char r0, char r1, char r2, char r3, bool rev=false);
...
public:
    ...
    public:
        ...
        Context(char *b, unsigned char m, unsigned char p, 
                LiquidCrystalFast *l, unsigned char c, unsigned char r,
                bool si);
